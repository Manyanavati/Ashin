        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is('admin/permissions*') ? 'menu-open' : '' }} {{ request()->is('admin/roles*') ? 'menu-open' : '' }} {{ request()->is('admin/users*') ? 'menu-open' : '' }} {{ request()->is('admin/members*') ? 'menu-open' : '' }}">
                ...
                @can('libbook_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.libbooks.index") }}" class="nav-link {{ request()->is('admin/libbooks') || request()->is('admin/libbooks/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('cruds.libbook.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
                @can('book_boorewer_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.book-boorewers.index") }}" class="nav-link {{ request()->is('admin/book-boorewers') || request()->is('admin/book-boorewers/*') ? 'active' : '' }}">
                            <i class="fa-fw fas fa-cogs">

                            </i>
                            <p>
                                <span>{{ trans('cruds.bookBoorewer.title') }}</span>
                            </p>
                        </a>
                    </li>
                @endcan
