...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bookBoorewer.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.book-boorewers.update", [$bookBoorewer->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
